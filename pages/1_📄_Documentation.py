...
from theme import BASE_CSS, render_navbar

st.set_page_config(page_title="Mbarira AI - Documentation", page_icon="\U0001F4D8", layout="wide")
st.markdown(BASE_CSS, unsafe_allow_html=True)
st.markdown(render_navbar("Documentation"), unsafe_allow_html=True)
        ...
        st.markdown(
            ...
            <ul class="mb-timeline">
                ...
                <li>
                    ...
                    <p class="step-meta">removes duplicate boxes on the same physical slot and
                    detections that fall outside the digit row -- using only the geometry of
                    what the model found, never a fixed digit count</p>
                </li>
                <li>
                    <p class="step-title">5. Build the reading</p>
                    <p class="step-meta">sorts surviving digits left-to-right by position</p>
                </li>
            </ul>
            """,
            unsafe_allow_html=True,
